...
export default function TwoPageFormApp() {
  ...
  if (page === 'home') {
    return (
      <div className="form-container" style={{ maxWidth: '1300px', margin: '0 auto', border: 'none', padding: '20px' }}>
      ...
      <form onSubmit={handleSubmit}>  
        ...
        {/* Form Entries Section (Wider) */}
        <div style={{ display: 'flex', flexDirection: 'column', flex: 2, marginRight: '30px' }}>
          {/* Family, Brand, and Package */}
        ...
        {/* Calculations Section (Narrower) */}
        <div className="calculations" style={{ flex: 1, backgroundColor: 'white', color: 'black', padding: '10px', borderRadius: '5px' }}>
